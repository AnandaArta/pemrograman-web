...
<body>
    ...
    ?>
    <div class="container">
        <h2>Pendaftaran Mata Kuliah versi 2 </h2>   
    <!-- Ini Modal -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6"><span id="jsks"></span> sks</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="proses" type="submit" class="btn btn-primary" data-dismiss="modal">Submit</button>
                    </div>
                </div>
            </div>
        </div>

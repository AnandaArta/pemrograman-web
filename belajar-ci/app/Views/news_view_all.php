        ...
        <div class="wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="container mt-5">
                    <h2> List Berita </h2>   
                    <a href="<?= base_url('https://belajar-ci.test/admin/news/create')?>" class="btn btn-info mb-2">Add berita</a>
                    <div class="row mt-3">
                        <div class="col-sm-12">
                            <table class="table table-striped" id="tableuser">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('https://belajar-ci.test/admin/news/edit/'.$pengguna['id']);?>" class="btn btn-warning">Edit</a>
                                            <a href="<?= base_url('https://belajar-ci.test/admin/news/delete/'.$pengguna['id']);?>" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                    <?php endif; ?>
